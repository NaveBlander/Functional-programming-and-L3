...
// ========================================================
// Closure for L4 - using a frame-based representation.
export type Closure = {
  tag: "Closure";
  params: VarDecl[];
  body: CExp[];
...
export const makeObject = (ref: Class, args: Value[]): Object =>
    ({tag: "Object", ref: ref, args: args, env: makeEmptyEnv()});

export const makeObjectEnv = (ref: Class, args: Value[], env: Env): Object => 
    ({tag: "Object", ref: ref, args: args, env: env});
...
>>>>>>> 0b831ffed4ae544b7c2308b899bc0f8f56ff1c3b
    val;
